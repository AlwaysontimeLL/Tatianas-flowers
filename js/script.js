...
function changeItem3() {
	document.getElementById('quote3').style.opacity = '1';
}
function rechangeItem3() {
	document.getElementById('quote3').style.opacity = '0';
}

function changeItem4() {
	document.getElementById('quote4').style.opacity = '1';
}
function rechangeItem4() {
	document.getElementById('quote4').style.opacity = '0';
}
